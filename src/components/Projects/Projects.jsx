        ...
        <>
            ...
            <div id="project" className="mt-5 p-2">
                ...
                <div className="grid grid-cols-1 w-full md:grid-cols-2 gap-6">
                    ...
                    <div className=" cursor-pointer bg-[#FFFFFF] border-b text-black border-gray-200 rounded-lg shadow">
                        <a href="#">
                            <img className="rounded-t-lg" src="https://i.postimg.cc/4xHKxf6D/120116.jpg" />
                        </a>
                        <div className="p-5">
                            <a>
                                <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900">E learn</h5>
                            </a>
                            <p className="mb-3 font-normal ">This is an online learning application where student&apos;s or any person can gain different knowledges.</p>
                            {/* span to hold tags */}
                            <span className="flex gap-1">
                                <span className="bg-[#C6E9BC] p-2 font-semibold text-xs rounded-md">Node</span>
                                <span className="bg-[#001E2B] p-2 text-white font-semibold text-xs rounded-md">Mongodb</span>
                            ...
                            <section className="flex justify-between">
                                <a target="_blank" className="text-[#255BF9] flex gap-3 items-center mt-6 " href="https://github.com/Emranhossainshuvo/e-learn"><span className="hover:font-bold ">Github repository</span> <FaLongArrowAltRight /></a>
                                <a className="text-[#255BF9] flex gap-3 items-center mt-6 " href="https://learn-onk3.netlify.app"><span className="hover:font-bold ">Live link</span> <FaLongArrowAltRight /></a>
                            </section>
